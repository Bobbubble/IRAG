...
def main(args):
    ...
    for epoch in range(args.num_epochs):
        ...
        print(f"Epoch: {epoch}|{args.num_epochs}: Completion Train Loss (Epoch Mean): {completion_epoch_loss / len(train_loader)}")
        ...
        print(f"Epoch: {epoch}|{args.num_epochs}: Total Train Loss (Epoch Mean): {total_epoch_loss / len(train_loader)}")
